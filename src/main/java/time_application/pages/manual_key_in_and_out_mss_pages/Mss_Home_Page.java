...
public class Mss_Home_Page {
	...
	public void search_Team_Click() {


		WebElement search_Team_Click = driver.findElement(By.xpath("//div[@id=\"mobTeam\"]//ng-select"));
		wait.until(ExpectedConditions.visibilityOf(search_Team_Click));
		action.click(search_Team_Click).build().perform();
		
		WebElement Team_Click = driver.findElement(By.xpath("//div[@title='Suryakumar Yadhav']//label"));
		wait.until(ExpectedConditions.visibilityOf(Team_Click));
		action.click(Team_Click).build().perform();
		
		WebElement Team_check = driver.findElement(By.xpath("//div//span[@title=\"Suryakumar Yadhav\"]"));
		wait.until(ExpectedConditions.visibilityOf(Team_check));
		Assert.assertEquals(Team_check.getText(), "Suryakumar Yadhav","Test failed - team member is not selected");
		
		WebElement close_click = driver.findElement(By.xpath("//div//span[@title=\"Suryakumar Yadhav\"]//parent::div//parent::div//div//a//img[contains(@src,tl_widgetClose.svg) and not(@id=\"userLoginImg\")]"));
		wait.until(ExpectedConditions.visibilityOf(close_click));
		action.click(close_click).build().perform();
